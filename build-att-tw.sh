...
make VARIANT_DEFCONFIG=jf_att_defconfig SELINUX_DEFCONFIG=jfselinux_defconfig SELINUX_LOG_DEFCONFIG=jfselinux_log_defconfig chronic_jf_defconfig
...
if [ -e $KERNELDIR/arch/arm/boot/zImage ]; then
	...
	rm ramdisk.gz
	rm zImage
	rm ../ChronicKernel-TW-jfatt*.zip
	zip -r ../ChronicKernel-TW-jfatt-$curdate.zip .
	cd $KERNELDIR
else
