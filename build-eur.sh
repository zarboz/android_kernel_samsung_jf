...
make VARIANT_DEFCONFIG=jf_eur_defconfig SELINUX_DEFCONFIG=jfselinux_defconfig SELINUX_LOG_DEFCONFIG=jfselinux_log_defconfig chronic_jf_defconfig
...
if [ -e $KERNELDIR/arch/arm/boot/zImage ]; then
	...
	rm ramdisk.gz
	rm zImage
        rm -r ../ChronicKernel-AOSP-JFeur*.zip
	zip -r ../ChronicKernel-AOSP-JFeur-$curdate.zip .
	cd $KERNELDIR
else
